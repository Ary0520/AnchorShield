          ...
          <div style={{ paddingTop: 16 }}>
              {wallet.publicKey ? (
                <button 
                  ...
                  style={{ width: "100%", background: "rgba(255,255,255,0.06)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", border: "1px solid rgba(255,255,255,0.12)", boxShadow: "0 8px 32px 0 rgba(0,0,0,0.2), inset 0 1px 2px rgba(255,255,255,0.1)", color: "#ffffff", fontFamily: "'General Sans', sans-serif", fontWeight: 700, fontSize: 14, padding: "10px 16px", cursor: "pointer", textAlign: "center", borderRadius: "10px", transition: "all 0.2s ease" }} 
                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = "rgba(255,255,255,0.02)"; (e.currentTarget as HTMLElement).style.borderColor = "rgba(255,255,255,0.06)"; }} 
                ...
                <button 
                  ...
                  style={{ width: "100%", background: "rgba(255,255,255,0.06)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", border: "1px solid rgba(255,255,255,0.12)", boxShadow: "0 8px 32px 0 rgba(0,0,0,0.2), inset 0 1px 2px rgba(255,255,255,0.1)", color: "#ffffff", fontFamily: "'General Sans', sans-serif", fontWeight: 700, fontSize: 14, padding: "10px 16px", cursor: wallet.isConnecting ? "not-allowed" : "pointer", opacity: wallet.isConnecting ? 0.6 : 1, textAlign: "center", borderRadius: "10px", transition: "all 0.2s ease" }} 
                  onMouseEnter={e => { if(!wallet.isConnecting) { (e.currentTarget as HTMLElement).style.background = "rgba(255,255,255,0.02)"; (e.currentTarget as HTMLElement).style.borderColor = "rgba(255,255,255,0.06)"; } }} 
                  onMouseLeave={e => { if(!wallet.isConnecting) { (e.currentTarget as HTMLElement).style.background = "rgba(255,255,255,0.06)"; (e.currentTarget as HTMLElement).style.borderColor = "rgba(255,255,255,0.12)"; } }}
                >
            ...
            {/* Wallet — desktop only */}
              {wallet.publicKey && (
                <button 
                  ...
                  style={{ padding: "6px 14px", background: "rgba(255,255,255,0.06)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", border: "1px solid rgba(255,255,255,0.12)", boxShadow: "0 8px 32px 0 rgba(0,0,0,0.2), inset 0 1px 2px rgba(255,255,255,0.1)", borderRadius: "8px", color: "#ffffff", fontFamily: "'JetBrains Mono', monospace", fontSize: 11, cursor: "pointer", transition: "all 0.2s ease" }} 
                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = "rgba(255,255,255,0.02)"; (e.currentTarget as HTMLElement).style.borderColor = "rgba(255,255,255,0.06)"; }} 
                  onMouseLeave={e => { (e.currentTarget as HTMLElement).style.background = "rgba(255,255,255,0.06)"; (e.currentTarget as HTMLElement).style.borderColor = "rgba(255,255,255,0.12)"; }}
                >
                  {wallet.shortKey}
